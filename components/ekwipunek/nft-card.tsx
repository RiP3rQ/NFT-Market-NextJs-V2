...
const NftCard = ({ title, description, image, id }: NftCardProps) => {
  ...
  return (
    <div
      key={id}
      id={id}
      className="flex flex-col items-center justify-center space-y-2 border-2 bg-gray-100 p-4 ww-80 h-96 cursor-pointer rounded-lg hover:bg-slate-500 hover:opacity-70 "
